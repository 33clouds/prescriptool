...
ActiveRecord::Schema[7.0].define(version: 2022_12_13_102508) do
  ...
  create_table "meds_prescriptions", force: :cascade do |t|
    t.string "dosage"
  ...
  create_table "users_specialties", force: :cascade do |t|
    t.bigint "specialty_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["specialty_id"], name: "index_users_specialties_on_specialty_id"
    t.index ["user_id"], name: "index_users_specialties_on_user_id"
  end
  ...
  add_foreign_key "users_specialties", "users"
end
